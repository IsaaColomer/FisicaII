...
#ifdef _DEBUG
#pragma comment( lib, "Box2D/libx86/_Debug/Box2D.lib" )
#else
#pragma comment( lib, "Box2D/libx86/_Release/Box2D.lib" )
#endif
...
PhysBody* ModulePhysics::CreateCircleSensor(int x, int y, int radius, b2BodyType type)
{
	b2BodyDef body;
	body.type = type;
	body.position.Set(PIXEL_TO_METERS(x), PIXEL_TO_METERS(y));
