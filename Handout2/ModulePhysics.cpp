...
update_status ModulePhysics::PostUpdate()
{
	...
	if(App->input->GetKey(SDL_SCANCODE_2) == KEY_DOWN)
	{
		...
		body1.position.Set(PIXEL_TO_METERS(App->input->GetMouseX()), PIXEL_TO_METERS(App->input->GetMouseY()));
	...
	if(App->input->GetKey(SDL_SCANCODE_3) == KEY_DOWN)
	{
		...
		body.position.Set(PIXEL_TO_METERS(App->input->GetMouseX()) - 1.0f, PIXEL_TO_METERS(App->input->GetMouseY()) - 0.5f);
